...
from vwatcher.collect.snmp import SnmpError, SystemInfo, ZinoSession, open_session
...
class TestZinoSession:
    async def test_should_return_the_uptime_as_integer(self, zino_session):
    ...
    async def test_should_decode_string_backend_hands_over_as_bytes(self, zino_session):
    ...
    async def test_when_string_cannot_be_decoded_then_it_should_be_replaced(self, zino_session):
    ...
    async def test_should_raise_timeout_as_snmp_error(self, zino_session):
    ...
    async def test_when_error_carries_no_message_then_it_should_be_named(self, zino_session):
