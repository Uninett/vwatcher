...
More information about contributing to vwatcher can be found in the
[README](https://github.com/Uninett/vwatcher/blob/main/README.md#developing-vwatcher).

<!-- Add an "X" inside the brackets to confirm -->
<!-- If not checking one or more of the boxes, please explain why below each. -->

* [ ] Added a changelog fragment for [towncrier](https://github.com/Uninett/vwatcher/blob/main/README.md#developing-vwatcher)
...
* [ ] Linted/formatted the code with ruff, easiest by using [pre-commit](https://github.com/Uninett/vwatcher/blob/main/README.md#developing-vwatcher)
